...
def create_stream_router(price_cache: PriceCache) -> APIRouter:
    ...
    A fresh APIRouter is created each call to avoid double-registration.
    """
    ...
    async def stream_prices(request: Request) -> StreamingResponse:
        ...
        Emits one JSON event per ticker per ~500ms cadence:

            data: {"ticker": "AAPL", "price": 190.50, "prev_price": ..., ...}
